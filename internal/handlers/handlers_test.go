...
func Test_PostCheckAvailabilityJSON_ErrorParse(t *testing.T) {

	// create a request instance
	request, _ := http.NewRequest("POST", "/check-availability/json", nil)
...
func Test_PostCheckAvailabilityJSON_NoRoomId(t *testing.T) {
...
func Test_PostCheckAvailabilityJSON_DBError(t *testing.T) {
...
func Test_PostCheckAvailabilityJSON_NoStartDate(t *testing.T) {
...
func Test_PostCheckAvailabilityJSON_NoEndDate(t *testing.T) {
...
func Test_PostCheckAvailabilityJSON_NoAvailRooms(t *testing.T) {
